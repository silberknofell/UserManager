...
export class User implements ObjectWithId{
    ...
    constructor(private vorname:string = "Vorname",
                private nachname:string = "Nachmname",
                public id:number = 0,
                private kennwort:string = "",
                private login:string,
                private gruppe:string = "Schueler",
                private klasse:string = "Klasse") {
        if (this.login == "") {
    ...
    private static removeAccents(text:string) { //TODO
    ...
    public difference(user2:User):string[] {
        let result = [];
    ...
    private check(s:string, user:User, result:string[]) {
        if (this[s] !=  user[s]) {
            result.push(s);
        }
    }
